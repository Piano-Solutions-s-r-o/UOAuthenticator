...
export function stripIpv6Brackets(address: string): string {
...
export async function resolvePublicDestinations(url: URL): Promise<PublicDestination[]> {
...
export function createPinnedAgent(url: URL, destination: PublicDestination): Agent {
